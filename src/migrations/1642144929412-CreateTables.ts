...
export class CreateTables1642144929412 implements MigrationInterface {
  name = 'CreateTables1642144929412';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "jobs"
                             (
                                 ...
                                 "id"      SERIAL            NOT NULL,
                                 CONSTRAINT "UQ_e480da468fa5ef0b9a8f90c438e" UNIQUE ("name"),
                                 CONSTRAINT "UQ_e480da468fa5ef0b9a8f90c438e" UNIQUE ("name"),
